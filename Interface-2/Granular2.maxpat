...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 309.0, 80.0, 22.0 ],
					"text" : "prepend read"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 431.0, 265.0, 74.0, 22.0 ],
					"text" : "r #0_loadfile"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2945.0, 651.0, 76.0, 22.0 ],
					"text" : "s #0_loadfile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1585.0, 17.0, 87.0, 22.0 ],
					"text" : "loadmess 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 2825.1162109375, 639.0, 40.0, 22.0 ],
					"text" : "* 999."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 2714.1162109375, 639.0, 40.0, 22.0 ],
					"text" : "* 999."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 2616.593017578125, 639.0, 29.5, 22.0 ],
					"text" : "* 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 239.404510498046875, 30.0, 90.0, 22.0 ],
					"text" : "r #0_sampFreq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2825.1162109375, 669.0, 92.0, 22.0 ],
					"text" : "s #0_sampFreq"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2714.1162109375, 669.0, 81.0, 22.0 ],
					"text" : "s #0_duration"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2616.593017578125, 669.0, 66.0, 22.0 ],
					"text" : "s #0_width"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 2774.1162109375, 583.0, 220.0, 22.0 ],
					"text" : "route width duration sampFreq seq load"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2721.093017578125, 89.557075500488281, 51.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2778.1162109375, 83.057075500488281, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 2058.0, 350.0, 66.0, 22.0 ],
					"text" : "print #0dur"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2242.0, 67.557075500488281, 131.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.0, 394.5330810546875, 133.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 412.0, 363.0, 48.0, 22.0 ],
					"text" : "del 200"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 412.0, 330.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3995.33349609375, 140.05706787109375, 143.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3890.000244140625, 242.55706787109375, 141.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.404510498046875, 339.5330810546875, 198.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-47", 0 ],
					"midpoints" : [ 2251.5, 99.557079250244144, 2165.301758000000063, 99.557079250244144 ],
					"source" : [ "obj-152", 0 ]
				}
